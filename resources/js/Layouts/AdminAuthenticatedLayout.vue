...
<template>
    <div>
        <div class=" flex flex-col h-screen">
          <nav class="shrink-0 flex justify-between bg-white px-4 py-3 border-b navbar navbar-expand-md">
              ...
              <div class="flex items-center">
                  <NavLink :href="route('admin.dashboard')">Dashboard</NavLink>
                  ...
                  <Menu as="div" class="m-3 relative z-10">
                      <MenuButton class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400 rounded-full"> 
                          ...
                          alt="$pages.props.auth.admin.name">
                      </MenuButton>
          ...
          <div class="font-poppins antialiased fixed">
            <div
              id="view"
              class=""
              x-data="{ sidenav: true }"
            >
              ...
              >
                <div class="space-y-6 md:space-y-10 mt-10">
                  <div class="flex items-center pl-7 pt-0 mt-0">
                      <img class="m-2 h-9 w-9 squared-full" src="https://nbsc.edu.ph/is/assets/img/nbsclogo.png" alt="">
                      <a class="text-2xl font-sans font-bold tracking-tight" :href="route('admin.dashboard')">PROBE</a>
                  </div>
                  <UserInfo />
                  <div id="menu" class="flex flex-col space-y-2">
                    <a
                      ...
                      class="flex items-center justify-start text-sm font-medium text-gray-700 py-2 px-2 hover:bg-blue-600 hover:text-white hover:text-base rounded-md transition duration-150 ease-in-out"
                    >
                      <svg
                    ...
                    <a
                      ...
                      class="flex items-center justify-start text-sm font-medium text-gray-700 py-2 px-2 hover:bg-blue-600 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
                    >
                      <svg
                        class="w-6 h-6 fill-current inline-block"
                        fill="currentColor"
