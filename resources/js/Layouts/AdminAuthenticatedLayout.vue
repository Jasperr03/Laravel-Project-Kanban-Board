                ...
                <div class="space-y-6 md:space-y-10 mt-10">
                  ...
                  <div id="menu" class="flex flex-col space-y-2">
                    ...
                    >
                      ...
                      <span class="m-0 p-0">Dashboard</span>
                    </a>
 
                    <a :href="route('admin.users')" class="flex items-center justify-start gap-4 text-sm font-medium text-gray-700 py-2 px-2 hover:bg-blue-600 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out">
                      <svg
                        class="w-6 h-6 fill-current inline-block"
                        fill="currentColor"
                        viewBox="0 0 20 20"
