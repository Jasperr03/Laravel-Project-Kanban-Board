          ...
          <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
            ...
            <DialogPanel
              ...
              <div class="flex flex-col sm:flex-row">
                <form @submit.prevent="onSubmit" class="flex-1 p-5">
                  <div>
                    <label for="title" class="sr-only"> Title</label>
                    <TextareaAutosize v-model="form.title" id="title"
                      class="block w-full text-sm rounded-md border-gray-300 shadow-sm focus:border-blue-400 focus:ring-blue-400"
                      name="title" rows="1" />
                  </div>

                  <div class="mt-4">
                    <label class="inline-block mb-1 text-sm font-semibold text-gray-700"
                      for="description">Description</label>
                    <TextareaAutosize v-model="form.description" id="description"
                      class="block w-full text-sm rounded-md border-gray-300 shadow-sm focus:border-blue-400 focus:ring-blue-400"
                      name="description" rows="4"></TextareaAutosize>
                  </div>
                  ...
                  <div class=" py-12 px-4">
                    <div class="max-w-7xl mx-auto sm:px6 lg:px-8">
                      <div @drop.prevent="onDroppedFiles" @dragover.prevent="dragging = true"
                        ...
                        <svg class="w-12 h-12 text-gray-500 " aria-hidden="true" fill="none" stroke="currentColor"
                          viewBox="0 0 48 48">
                          <path
                        ...
                        <label
                          class=" bg-gray-200 px-2 h-7 inline-flex items-center rounded border border-gray-300 shadow-sm text-sm text-gray-700 focus-within:ring-2 focus-within:ring-ofser-2 focus-within:ring-indigo-500 ">
                          Select Files
                    ...
                    <ul class="my-6 bg-gray-200 rounded divide-y divide-gray-300 shadow">
                      <li v-for="(item, index) in media" :key="index" class="p-3 flex items-center space-x-1">
                        ...
                        <div v-if="!item.uploaded && !item.error"
                          class="w-40 bg-gray-500 rounded-full h-5 shadow-inner overflow-hidden relative flex items-center justify-center">
                          <div class="inline-block h-full bg-indigo-600 absolute top-0 left-0"
                  ...
                  <div class="mt-2 space-x-2">
                    ...
                    <a type="button"
                      ...
                      :href="route('boards.show', { board: props.card.board_id })">Cancel
                    </a>
                  </div>
                </form>
                <div class="p-5 bg-gray-100 sm:w-48">
                  ...
                  <Link :href="`/cards/status/${card?.id}`" method="put" as="button"
                  ...
                  <svg class="h-5 w-5 mr-2" xmlns="http://www.w3.org/2000/svg" height="16" width="14"
                    viewBox="0 0 448 512">
                    <path
                  ...
                  <Link :href="`/cards/${card?.id}`" method="delete" as="button"
