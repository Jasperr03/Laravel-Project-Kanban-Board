    ...
    methods: {
        async fetch() {
            try {
                ...
                // Group data by month
                const groupedData = data.boards.reduce((acc, entry) => {
            ...
            try {
                ...
                const filename = `board_graph_${timestamp}`;
...
<template>
    <div class="cardReport">
        <div class="flex items-center justify-between mb-4">
            <h2 class="mb-0 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Boards Graph</h2>
